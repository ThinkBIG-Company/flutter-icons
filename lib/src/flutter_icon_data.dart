...
class FlutterIconData extends IconData {
  ...
  const FlutterIconData.fontAwesome5Regular(int codePoint) : this(codePoint, 'FontAwesome5');
...
class IconDataDuotone extends IconData {
  ...
  const IconDataDuotone(int codePoint, {this.secondary}) : super(codePoint, fontFamily: 'MaterialIcons-TwoTone', fontPackage: 'flutter_icons');
}
