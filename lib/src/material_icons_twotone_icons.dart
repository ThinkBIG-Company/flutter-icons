...
class MaterialIconsDuotoneIcon extends StatelessWidget {
  ...
  /// 24.0.
  ///
  /// If this [MaterialIcon] is being placed inside an [IconButton], then use
  ...
  const MaterialIconsDuotoneIcon(
    this.icon, {
    Key? key,
    this.size,
    this.primaryColor = const Color(0XFF9B9B9B),
